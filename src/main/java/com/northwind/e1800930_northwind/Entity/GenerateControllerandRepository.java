package com.northwind.e1800930_northwind.Entity; //your own package

import java.io.File;
import java.io.FileWriter;

public class GenerateControllerandRepository {
    private static File file = new File("/home/julia2369/Documents/database/e1800930_northwind/src/main/java/com/northwind/e1800930_northwind/Entity/"); //your folder path
    //Create the file
            ...
            if (checkFile.isDirectory()) {checkAndGetFileName(checkFile);}
                ...
                if(checkFile.isFile()){
                    ...
                    if(extension.equals("java")) {
                        ...
                        if(!newFileName.equals("GenerateControllerandRepository") && !newFileName.equals("E1800930NorthwindApplication") && !newFileName.contains("Controller") && !newFileName.contains("Repository")){
    ...
    public static void createRepository(String name){
        try {
            ...
            write.write("package com.northwind.e1800930_northwind.Entity;\n\n");
